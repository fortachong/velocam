...
spatialDetectionNetwork.setBlobPath(blobconverter.from_zoo(name='vehicle-detection-adas-0002', shaves=5))
...
objectTracker.setDetectionLabelsToTrack([1])  # track only cars
